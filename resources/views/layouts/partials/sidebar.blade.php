<aside class="fixed left-0 top-0 h-screen w-[280px] bg-surface-container-lowest border-r border-outline-variant flex flex-col py-stack-lg px-gutter z-50">
    ...
    <nav class="flex-1 space-y-1">
        ...
        {{-- لا يوجد route فعلي لهالاثنين حتى الآن — خليتهم معطّلين بصريًا بدل ما يوديو لصفحة 404 --}}
        <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-outline-variant " title="Coming soon">
    ...
    <div class="mt-auto border-t border-outline-variant pt-6 flex items-center gap-3">
        <img class="w-10 h-10 rounded-full border border-outline-variant object-cover"
             src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZ3esGvmB655eRc8pryGKB6q4kPUjbys8kvDNTRGsPPZjby7rUPzTUaSi7lb4_WFvRC87tUAdqn1qst_CsDp3DkHATLS5TzphG_EewvOZJZBbNm4ShyXWC_rLaTjG_qjKvHGs61YwMu1rSQI-OAwZCjaJCJhImIqxxiiS6q1-xhkGDTwQPw-CYICjZuGBB7smfJWdlFJt7eRca6ZroQbAQPZeUHCdj5bxYms0CB10-g9z1djGIawd29sF6AbsvoVlEapUYB5JSbg"
             alt="{{ auth()->user()->name }}">
